...
- 2026.08.29 更新了移除观察模式遗留代码、家庭设置默认“加入家庭”与家庭码输入框初始可见、打开应用自动向全员请求一次实时位置、自启动管理改为引导搜索；修复了加入家庭后看不到其他成员、家庭码输入框需先切走再切回才出现。----- 提交于 2026.08.29
- 2026.08.29 开源准备：新增 README（中/英）、LICENSE（MIT）、.gitignore；敏感信息（Key/口令/域名）脱敏；README 加入“提供服务器”联系方式。----- 提交于 2026.08.29
